    ...
    <div class="sale">
      ...
      <ul class="sale_items">
        <li>
          <span>今日检验总数</span>
          <p class="nums">
            <count-to :start-val="0" :end-val="dataForm.dayNum" :duration="2600" class="card-panel-num"/>
          </p>
          <!--          <span>+2.34%</span>-->
        </li>
        <li>
          <span>检验不合格数</span>
          <p class="nums">
            <count-to :start-val=" 0 " :end-val="dataForm.disqualificationNum" :duration="3600" class="card-panel-num"/>
          </p>
          <!--          <span>-0.3%</span>-->
        </li>
        <li>
          <span>检验不合格率</span>
          <span>{{dataForm.fractionDefective}}</span>
          <!--          <span>活动时间48小时</span>-->
        </li>
        <!--        <li>
                  <span>每秒交易总额</span>
...
<!--        <el-date-picker v-model="value1" type="date" placeholder="选择日期" size="small">
    ...
    <!--      </el-col>-->
    <!--    </el-row>-->
    <p class="componey">Copyright © 2022 质量管理</p>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      dataForm: {
        dayNum:undefined,
        disqualificationNum:undefined,
        fractionDefective:undefined,
      },
      value1: '',
      charts: '',
  ...
  methods: {
    initData() {
      request({
        url: `/api/project/index/getIndexData`,
        method: 'post'
      }).then(res => {
