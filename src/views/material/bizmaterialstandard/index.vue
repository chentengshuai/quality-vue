        ...
        >
          ...
          <el-table-column label="操作" fixed="right" width="150">
            <template slot-scope="scope">
              <el-button
                type="text"
                v-if="scope.row.currentApproval == 1"
                @click="approval(scope.row.id, 'examine')"
                >审核
              </el-button>
              <el-button
                type="text"
                v-if="scope.row.currentApproval == 2"
                @click="approval(scope.row.id, 'approval')"
                >核准
              </el-button>
              <el-button
                type="text"
              ...
              <el-button
                ...
                @click="addOrUpdateHandle(scope.row.id, 'looke')"
                >详情
              </el-button>
              <el-button
                type="text"
              ...
              <el-button
                type="text"
                v-if="scope.row.approvalState == 3 && scope.row.enableFlag==0"
                @click="setEnableFlag(scope.row.id, 1)"
                >启用
              </el-button>
              <el-button
                type="text"
                v-if="scope.row.approvalState == 3 && scope.row.enableFlag==1"
                @click="setEnableFlag(scope.row.id, 0)"
                >停用
              </el-button>
              <el-button
                type="text"
                v-if="scope.row.approvalState == 3"
                @click="approval(scope.row.id, 'revoke')"
                >撤回
              </el-button>
            </template>
          </el-table-column>
