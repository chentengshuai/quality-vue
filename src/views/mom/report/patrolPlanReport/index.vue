...
<script>
    ...
    import RulesUnPatrolList from './rulesUnPatrolList'

    export default {
        components: {RightChar,LeftChar,RulesUnPatrolList},
        data() {
            return {
        ...
        methods: {
            initData(){
                ...
                request({
                    url: `/api/project/XjrPatrolplanBase/getPatrolPlanReportList`,
                    method: 'post',
                    data: _query
                }).then(res => {
                ...
                this.initData()
            }, rulesUnPatrolView(row) { 
                let patrolRulesCode=row.patrolRulesCode;
                this.rulesUnPatrolLisShow = true;
                this.$nextTick(() => {
                    this.$refs.RulesUnPatrolList.initData(patrolRulesCode);
                })
            },
        }
    }
