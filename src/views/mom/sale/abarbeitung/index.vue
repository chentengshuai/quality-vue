        ...
        <div class="JNPF-common-layout-center">
                ...
                <el-form @submit.native.prevent>
                        ...
                        <el-col :span="6">
                                <el-form-item label="整改意见">
                                        <el-input v-model="query.opinion" placeholder="请输入" clearable>  </el-input>
                                </el-form-item>
                            </el-col>
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
                ...
                <JNPF-table v-loading="listLoading" :data="list" @sort-change='sortChange' >
                            <el-table-column prop="userId" label="整改用户" width="0" align="left"
/>
                            <el-table-column prop="userName" label="整改用户名称" width="0" align="left"
/>
                            <el-table-column prop="opinion" label="整改意见" width="0" align="left"
/>
    ...
    export default {
        ...
        methods: {
            ...
            initData() {
                ...
                request({
                    url: `/api/project/Sale_marketing_abarbeitung/getList`,
                    method: 'post',
                    data: _query
                }).then(res => {
                    var _list =[];
            ...
            handleDel(id) {
                this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
                    ...
                    request({
                        url: `/api/project/Sale_marketing_abarbeitung/${id}`,
                        method: 'DELETE'
                    }).then(res => {
                        this.$message({
                            type: 'success',
            ...
            download(data) {
                ...
                request({
                    url: `/api/project/Sale_marketing_abarbeitung/Actions/Export`,
                    method: 'GET',
                    data: query
                }).then(res => {
