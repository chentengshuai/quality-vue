        ...
        <template v-if="!loading">
          <el-col :span="24">
            <el-form-item label="产品模板编码" prop="productTemplateCode">
              <el-input prefix-icon="el-icon-search" readonly v-model="dataForm.productTemplateCode" placeholder="请选择"
                        @click.native="materialShow()" clearable :style='{"width":"100%"}'>
              </el-input>
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="产品模板名称" prop="productTemplateName">
              <el-input v-model="dataForm.productTemplateName" readonly placeholder="请选择" clearable
                        :style='{"width":"100%"}'>
              </el-input>
            </el-form-item>
          </el-col>
...
export default {
  ...
  methods: {
    getproductTypeOptions() {
      ...
      getDictionaryDataByTypeCode('productTemplateType').then(res => {
