    ...
    <div class="import-main" v-show="active==3">
      ...
      <div class="unsuccess" v-if="result.resultType">
        ...
        <JNPF-table :data="resultList" height="280px">
          <el-table-column prop="orderNum" label="订单编码" width="100"/>
        </JNPF-table>
      </div>
    </div>
    ...
    methods: {
      ...
      next() {
        if (this.active == 2) {
          ...
          return request({
            url: '/api/project/Mom_order/ImportData',
            method: 'post',
            data: {
              list: this.list
            }
        ...
        if (this.active == 1) {
          ...
          this.btnLoading = true
          request({
            url: '/api/project/Mom_order/ImportPreview',
            method: 'get',
      ...
      templateDownload() {
        return request({
          url: '/api/project/Mom_order/templateDownload',
          method: 'get'
        }).then(res => {
