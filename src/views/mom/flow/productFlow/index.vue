    ...
    <div class="JNPF-common-layout-center">
      <el-row class="JNPF-common-search-box" :gutter="16">
        <el-form @submit.native.prevent>
          ...
          <el-col :span="6">
            <el-form-item label="产品流程编码">
              <el-input v-model="query.productFlowCode" placeholder="请输入" clearable></el-input>
            </el-form-item>
          </el-col>
          <template v-if="showAll">
            ...
            <el-col :span="6">
              <el-form-item label="产品类型">
                <el-input v-model="query.productType" placeholder="请输入" clearable></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="6">
...
export default {
  components: { FlowFormDialog,ExportBox },
  data() {
    return {
      showAll: false,
      query: {
  ...
  methods: {
    ...
    initData() {
      ...
      request({
        url: `/api/project/Bd_product_flow/getList`,
        method: 'post',
        data: _query
      }).then(res => {
        var _list = [];
    ...
    handleDel(id) {
      this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
        ...
        request({
          url: `/api/project/Bd_product_flow/${id}`,
          method: 'DELETE'
        }).then(res => {
          this.$message({
            type: 'success',
    ...
    addOrUpdateHandle(id, isDetail) {
      ...
      this.$nextTick(() => {
        this.$refs.FlowFormDialog.init(id, isDetail)
      })
    },
    exportData() {
    ...
    download(data) {
      ...
      request({
        url: `/api/project/Bd_product_flow/Actions/Export`,
        method: 'GET',
        data: query
      }).then(res => {
