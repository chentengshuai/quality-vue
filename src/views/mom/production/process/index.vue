        ...
        <el-form @submit.native.prevent>
          ...
          <el-col :span="6">
            <el-form-item label="生产工序名称">
              <el-input
                v-model="query.productionProcessName"
                placeholder="请输入"
                clearable
              >
              </el-input>
          ...
          <el-col :span="6">
            <el-form-item label="生产工序编码">
              <el-input
                v-model="query.productionProcessCode"
                placeholder="请输入"
                clearable
              >
              </el-input>
  ...
  methods: {
    ...
    handleDel(id) {
      this.$confirm("此操作将永久删除该数据, 是否继续?", "提示", {
        ...
        .then(() => {
          request({
            url: `/api/project/BdProductionProcess/${id}`,
            method: "DELETE",
          }).then((res) => {
            this.$message({
              type: "success",
    ...
    download(data) {
      ...
      request({
        url: `/api/project/BdProductionProcess/Actions/Export`,
        method: "GET",
        data: query,
      }).then((res) => {
