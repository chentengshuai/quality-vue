        ...
        <template v-if="!loading">
          ...
          <el-col :span="24">
            <el-form-item label-width="0">
              ...
              <el-table
                :data="dataForm.bdproductionprocessattributeList"
                size="mini"
              >
                <el-table-column
                  type="index"
                ...
                <el-table-column prop="isColumnAttribute" label="是否列属性">
                  <template slot-scope="scope">
                    <el-switch
                      v-model="scope.row.isColumnAttribute"
                      active-value="1"
                      inactive-value="0"
                    >
                    </el-switch>
                ...
                <el-table-column prop="standardType" label="标准类型">
                  <template slot-scope="scope">
                    <el-input
                      v-model="scope.row.standardType"
                      placeholder="请输入"
                      clearable
                      :style="{ width: '100%' }"
                    >
                ...
                <el-table-column prop="isPeriodicity" label="是否周期性">
                  <template slot-scope="scope">
                    <el-switch
                      v-model="scope.row.isPeriodicity"
                      active-value="1"
                      inactive-value="0"
                    >
                    </el-switch>
                ...
                <el-table-column label="操作" width="50">
                  <template slot-scope="scope">
                    <el-button
                      ...
                      @click="delbdproductionprocessattributeList(scope.$index)"
                      >删除</el-button
                    >
                  </template>
                </el-table-column>
              ...
              <div
                class="table-actions"
                @click="addbdproductionprocessattributeList()"
              >
