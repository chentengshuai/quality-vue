    ...
    <template v-if="!loading">
            ...
            <el-col :span="8" >
                <el-form-item  label="货品数量"   prop="materialNumber" >
                    <el-input-number v-model="dataForm.materialNumber" placeholder="数字文本" :step="1" controls-position='right' @blur="materialNumberChange(dataForm.materialNumber)">
                    </el-input-number>
                </el-form-item>
            </el-col>
            <el-col :span="8" >
                <el-form-item  label="抽样数"   prop="sampleNumber" >
                    <el-input-number v-model="dataForm.sampleNumber" placeholder="数字文本" :step="1" controls-position='right' @blur="sampleNumberChange(dataForm.sampleNumber)">
                    </el-input-number>
                </el-form-item>
            </el-col>
            <el-col :span="8" >
                <el-form-item  label="不良数"   prop="badNumber" >
                    <el-input-number v-model="dataForm.badNumber" placeholder="数字文本" :step="1" controls-position='right' @blur="badNumberChange(dataForm.badNumber)">
                    </el-input-number>
                </el-form-item>
            </el-col>
            <el-col :span="8" >
            ...
            <el-col :span="8" >
                <el-form-item  label="检验时间"   prop="inspectTime" >
                    <el-date-picker    v-model="dataForm.inspectTime" placeholder="请选择"  clearable  :style='{"width":"100%"}' type="date"  format="yyyy-MM-dd"  value-format="timestamp" >
                    </el-date-picker>
                </el-form-item>
            </el-col>
        ...
        <el-table-column type="index" width="50" label="序号" align="center" />
            <el-table-column prop="inspectionItems" label="检测项">
                <template slot-scope="scope">
                    <el-input   v-model="scope.row.inspectionItems" placeholder="请输入"  clearable  :style='{"width":"100%"}'>
                    </el-input>
                </template>
            </el-table-column>
            ...
            <el-table-column prop="inspectionMethod" label="检查方法">
                <template slot-scope="scope">
                    <el-input   v-model="scope.row.inspectionMethod" placeholder="请输入"  clearable  :style='{"width":"100%"}'>
                    </el-input>
                </template>
            </el-table-column>
            <el-table-column prop="inspectionFrequency" label="检查频率">
                <template slot-scope="scope">
                    <el-input   v-model="scope.row.inspectionFrequency" placeholder="请输入"  clearable  :style='{"width":"100%"}'>
                    </el-input>
                </template>
            </el-table-column>
            ...
            <el-table-column prop="sampleNumber" label="抽样数">
                <template slot-scope="scope">
                    <el-input-number v-model="scope.row.sampleNumber" placeholder="数字文本" :step="1" controls-position='right' @blur="rowNumberChange(scope.row)" :style='{"width":"100%"}'>
                    </el-input-number>
                </template>
            </el-table-column>
            <el-table-column prop="badNumber" label="不良数">
                <template slot-scope="scope">
                    <el-input-number v-model="scope.row.badNumber" placeholder="数字文本" :step="1" controls-position='right' @blur="rowNumberChange(scope.row)" :style='{"width":"100%"}'>
                    </el-input-number>
                </template>
            </el-table-column>
