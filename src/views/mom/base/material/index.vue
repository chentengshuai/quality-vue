        ...
        data() {
            return {
                ...
                columnList: [
                    ...
                    {prop: 'materialCode', label: '产品编码'},
                    {prop: 'materialSpec', label: '规格'},
                    {prop: 'materialModel', label: '型号'},
                    {prop: 'materialType', label: '类型'},
                    {prop: 'materialUnit', label: '单位'},
        ...
        methods: {
            ...
            handleDel(id) {
                this.$confirm('此操作将删除该数据, 是否继续?', '提示', {
                    ...
                    request({
                        url: `/api/project/Material/delete/${id}`,
                        method: 'POST'
                    }).then(res => {
                        this.$message({
                            type: 'success',
            ...
            download(data) {
                ...
                request({
                    url: `/api/project/Material/Actions/Export`,
                    method: 'GET',
                    data: query
                }).then(res => {
