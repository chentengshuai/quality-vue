    ...
    <template v-if="!loading">
            ...
            <el-col :span="12" >
                <el-form-item  label="上级部门"   prop="parentId" >
                    <el-input    v-model="dataForm.parentId" placeholder="请输入"  clearable  :style='{"width":"100%"}'>
            ...
            <el-col :span="12" >
                <el-form-item  label="状态是否启用"   prop="status" >
            ...
            init(id, isDetail) {
                ...
                this.$nextTick(() => {
                    ...
                    if(this.dataForm.id){
                        this.loading = true
                        request({
                            url: '/api/project/Department/'+this.dataForm.id,
                            method: 'get'
                        }).then(res => {
