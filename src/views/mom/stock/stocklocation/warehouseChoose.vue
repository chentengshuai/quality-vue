        ...
        <el-form @submit.native.prevent>
          <el-col :span="8">
            <el-form-item label="物料编码">
              <el-input v-model="query.warehouseCode" placeholder="请输入" clearable
                        @keyup.enter.native="search()"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="物料名称">
              <el-input v-model="query.warehouseName" placeholder="请输入" clearable
                        @keyup.enter.native="search()"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
  ...
  export default {
    ...
    methods: {
      ...
      initData() {
        ...
        request({
          url: `/api/project/Warehouse/getList`,
          method: 'post',
          data: _query
        }).then(res => {
          var _list = [];
