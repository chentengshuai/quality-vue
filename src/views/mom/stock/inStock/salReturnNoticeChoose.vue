<template>
  <el-dialog title="选择退货通知单"
             :close-on-click-modal="false" append-to-body
             :visible.sync="salReturnNoticeChooseShow" class="JNPF-dialog JNPF-dialog_center" lock-scroll
             width="1300px">
      ...
      <div class="JNPF-common-layout-center">
        ...
        <div class="JNPF-common-layout-main JNPF-flex-main">
          <JNPF-table v-loading="listLoading" :data="list" hasC @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="stockName" label="仓库" width="0" align="left"/>
            <el-table-column prop="rmTypeName" label="退货类型" width="0" align="left"/>
          </JNPF-table>
  ...
  export default {
    ...
    methods: {
      initData() {
        ...
        request({
          url: `/api/project/stockApi/getSalReturnNoticeList`,
          method: 'post',
          data: _query
        }).then(res => {
          var _list = [];
      ...
      closeDialog() {
        this.$emit('closeSalReturnNotice')
        this.resetNoInit();
      },
      confirm() {
        this.$emit('selectSalReturnNotice', this.checked)
        this.resetNoInit();
        this.$emit('closeSalReturnNotice')
      },
