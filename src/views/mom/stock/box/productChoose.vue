        ...
        <el-form @submit.native.prevent>
          <el-col :span="8">
            <el-form-item label="产品编码">
              <el-input v-model="query.productCode" placeholder="请输入产品编码查询" clearable
                        @keyup.enter.native="search()"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="产品尺寸">
              <el-input v-model="query.size" placeholder="请输入产品尺寸查询" clearable
                        @keyup.enter.native="search()"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
  ...
  export default {
    ...
    methods: {
      ...
      initData() {
        ...
        request({
          url: `/api/project/ProductProduct/finishedProductList`,
          method: 'post',
          data: _query
        }).then(res => {
          var _list = [];
      ...
      select() {
        console.warn("this:" + this.checked);
