    ...
    <div class="JNPF-common-layout-center">
        ...
        <el-form @submit.native.prevent>
          <el-col :span="8">
            <el-form-item label="客户编码">
              <el-input v-model="query.partnerCode" placeholder="请输入客户编码查询" clearable
                        @keyup.enter.native="search()"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="客户名称">
              <el-input v-model="query.partnerName" placeholder="请输入客户名称查询" clearable
                        @keyup.enter.native="search()"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
      ...
      <div class="JNPF-common-layout-main JNPF-flex-main">
        <JNPF-table v-loading="listLoading" :data="list" @sort-change='sortChange'
          ...
          <el-table-column prop="partnerCode" label="客户编码" width="0" align="left"/>
          <el-table-column prop="partnerName" label="客户名称" width="0" align="left"/>
        </JNPF-table>
  ...
  export default {
    ...
    methods: {
      ...
      initData() {
        ...
        request({
          url: `/api/project/Partner/customerList`,
          method: 'post',
          data: _query
        }).then(res => {
          var _list = [];
